...
ruta_input = BASE_DIR /"Inputs"/"Process data"/"Information_2019_2025"/"2022"
...
R1_1=pd.read_excel("Registro1-1 completo.xlsx")
R1_2=pd.read_excel("Registro1-2 completo.xlsx")
...
ruta_consolidado = BASE_DIR /"Outputs"/"2022"/"R1"
...
# Función para eliminar caracteres de control
def clean_excel_text(text):
    if isinstance(text, str):
        # Quita caracteres ASCII < 32 excepto tab (9), linefeed (10), carriage return (13)
        return re.sub(r"[\x00-\x08\x0B-\x0C\x0E-\x1F]", "", text)
    return text

# Aplica la función a todo el DataFrame
Consolidado = Consolidado.applymap(clean_excel_text)
